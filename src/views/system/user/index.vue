    ...
    <el-row :gutter="20">
      ...
      <el-col :span="19" :xs="24">
        ...
        >
          ...
          />
          <el-table-column label="用户密码" align="center" key="password" prop="password" v-if="columns[2].visible">
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除用户名称为"' + userName + '"的数据项？').then(function () {
